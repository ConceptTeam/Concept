...
void TextEditor::createMenu() {
    ...
    connect(closeAction, &QAction::triggered, this, &TextEditor::closeTE);
    }
...
void TextEditor::setId(int newid){this->id = newid;}

void TextEditor::setMain(MainWindow* newmain){this->main = newmain;}

void TextEditor::closeTE(){

main->removeTE(this->id);
